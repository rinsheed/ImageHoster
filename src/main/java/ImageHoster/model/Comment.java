...
public class Comment {
    ...
    //One comment should only belong to one user (owner) but one user can post multiple comments
    //FetchType is EAGER
    ...
    //One comment should only belong to one image, but one image can have multiple comments
    //FetchType is EAGER
    @ManyToOne(fetch = FetchType.EAGER)
